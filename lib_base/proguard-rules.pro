...
################demo#######################
-keep class com.zrx.chedai.common.model.bean.** { *; }  #不混淆某个包所有的类
-keep class com.zrx.chedai.common.widget.** { *; }  #不混淆某个包所有的类
...
-keep class com.location.yinggelingapp.common.view.** { *; } #自定义控件不参与混淆
-keep class com.location.yinggelingapp.common.utils.** { *;}



#android混淆代码后崩溃日志中不显示行号的有关问题
-renamesourcefileattribute SourceFile
-keepattributes SourceFile,LineNumberTable
...
#-----------处理实体类---------------
# 在开发的时候我们可以将所有的实体类放在一个包内，这样我们写一次混淆就行了。
-keep public class com.bt.RoadParking.model.entity.** {
    *;
}
#统一返回的实体类也需要不参与混淆
-keep public class com.bt.RoadParking.base.** {
    *;
}
