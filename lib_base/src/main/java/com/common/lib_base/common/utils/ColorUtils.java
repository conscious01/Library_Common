...
public class ColorUtils {
    ...
    public static ColorStateList generateThumbColorWithTintColor(final int tintColor) {
        int[][] states = new int[][]{
                {-ColorUtils.ENABLE_ATTR, ColorUtils.CHECKED_ATTR},
                {-ColorUtils.ENABLE_ATTR},
                {ColorUtils.PRESSED_ATTR, -ColorUtils.CHECKED_ATTR},
                {ColorUtils.PRESSED_ATTR, ColorUtils.CHECKED_ATTR},
                {ColorUtils.CHECKED_ATTR},
                {-ColorUtils.CHECKED_ATTR}
        };
    ...
    public static ColorStateList generateBackColorWithTintColor(final int tintColor) {
        int[][] states = new int[][]{
                {-ColorUtils.ENABLE_ATTR, ColorUtils.CHECKED_ATTR},
                {-ColorUtils.ENABLE_ATTR},
                {ColorUtils.CHECKED_ATTR, ColorUtils.PRESSED_ATTR},
                {-ColorUtils.CHECKED_ATTR, ColorUtils.PRESSED_ATTR},
                {ColorUtils.CHECKED_ATTR},
                {-ColorUtils.CHECKED_ATTR}
        };
