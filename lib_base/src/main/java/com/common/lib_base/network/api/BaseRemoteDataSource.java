...
import com.common.lib_base.common.utils.BaseUrlUtils;
import com.common.lib_base.common.utils.BaseJsonObject;
...
public class BaseRemoteDataSource implements BaseIDataSource {
    ...
    private Retrofit initialize() {
        ...
        return new Retrofit.Builder().client(okHttpClient).baseUrl(BaseUrlUtils.getInstance().getRetrofitBaseUrl())
            .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
            .addConverterFactory(BaseEncryptGsonConverterFactory.create()).build();
    }

    @Override
    public Observable<BaseResponseEntity<String>> doLogin(String name, String password, String deviceId) {
