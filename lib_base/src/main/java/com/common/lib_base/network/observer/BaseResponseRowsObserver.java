...
public class BaseResponseRowsObserver<T extends BaseResponseRowsEntity> implements Observer<T> {
    ...
    public BaseResponseRowsObserver(BaseRequestPresenter presenter, BaseIStatusView view, Consumer<T> consumer) {
        this.mView = view;
    ...
    public BaseResponseRowsObserver(BaseRequestPresenter presenter, BaseIResponseView view, Consumer<T> consumer) {
        this.mView = view;
        this.mConsumer = consumer;
        this.mPresenter = presenter;
    }

    public BaseResponseRowsObserver(BaseRequestPresenter presenter, BaseIResponseView view, Consumer<T> consumer, String methodName) {
        this.mView = view;
        this.mConsumer = consumer;
        this.mPresenter = presenter;
