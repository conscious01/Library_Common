 ...
 */
package com.common.lib_base.base_view_vb;
...
public abstract class BaseVBActivity<VB extends ViewBinding> extends SupportActivity {
    ...
    public BaseVBActivity startActivity(Class<?> cls) {
